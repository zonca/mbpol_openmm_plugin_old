...
//    state                      = context.getState(State::Forces | State::Energy | State::Positions);
//    energy = state.getPotentialEnergy() / cal2joule;
//    forces         = state.getForces();
//
//    for( unsigned int ii = 0; ii < forces.size(); ii++ ){
//        forces[ii] /= cal2joule*10;
//        if ((particlesPerMolecule == 4) and ((ii+1) % particlesPerMolecule == 0)) { // Set virtual site force to 0
//            forces[ii] *= 0;
//        }
//    }
...
//    writePdbFrame("Tconst", 0, 0., state, particlesPerMolecule); // initial state
...
//        writePdbFrame("Tconst", frameNum, time_ps, state, particlesPerMolecule); // output coordinates
//
//        if (frameNum >= 2)
//        // if (time_ps >= 100.)
//            break;
...
//    }
    ...
    std::cout << "Potential energy after energy minimization: " << energy/cal2joule << " Kcal/mol" << std::endl;
